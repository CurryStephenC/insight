package com.wjyoption.web.controller.common;
...
import com.wjyoption.common.utils.file.FileUtils;
...
public class CommonController
{
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        try
        {
            ...
            String url = fileName;
//            String url = "";
//            if("1".equals(httpsSwitch)){
//            	url = "https://" + uploadwebsite + fileName;
//            }else{
//            	url = "http://" + uploadwebsite + fileName;
//            }
